...
(function() {
    ...
    var COLORS = [
        ...
        ["#efa653", "#e0bf9a", 10,  5, 15],
        ["#e5bb49", "#dbcba0", 10,  6, 15],
        ["#a4ad3c", "#c5c99f", 11,  6,  0],
        ["#75ad45", "#b2c6a1", 12,  7,  2],
        ["#5db255", "#a5c4a2", 13,  8,  4],
        ["#45ad6b", "#a2c1ae", 14,  9,  5],
        ["#45ad9c", "#9abfb9", 15, 10,  6],
        ["#469ac4", "#a3c0ce",  1, 12,  7],
        ["#5c83d1", "#abb8d3",  3, 12,  8],
        ["#7c75d1", "#b2afd3",  4, 13,  9],
        ["#996dc4", "#c1afd3",  5, 14, 10],
        ["#ba68c1", "#c6abc9",  6, 15, 11],
        ["#d164ac", "#d1afc5",  7,  1, 12],
        ["#d15c7f", "#d3afba",  8,  3, 12]
    ];
